...
singularity exec -B ${ROOTDIR}:${ROOTDIR} ${IMAGES}/macs2.simg macs2 callpeak -B -t example_input.bam -c sorted_unique_example.bam -n ${ROOTDIR}/pipeline/output_files/example_peaks
